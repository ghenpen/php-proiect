...
<label for="tabel">Alege un tabel:</label>
	...
	<form action="generare.php" method="post" style="position: absolute; left: 20px; top:200px;">
        <button class="button-54" type="submit">Generare PDF</button>
    </form>
</div>

<div style=" background-color: #AA6F73; width: 400px; height: 400px; position: absolute; top:210px; right:400px; font-size:20px; color:#66545E;">
<p>Grafic</p>
    <form action="generate_user_registration_graph.php" method="post">
